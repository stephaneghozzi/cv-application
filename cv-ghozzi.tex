...
\begin{minipage}{0.3\linewidth}
   \begin{center}
      \includegraphics[width=0.65\textwidth,right]{portrait-m-r-lr.png}
   \end{center}
\end{minipage} 
...
\noindent \begin{longtable}{@{}p{3.1cm}@{}@{}p{13.9cm}@{}} 
   ...
   & {\color{gray}\printdate{2003-9-1} -- \printdate{2004-8-31} $\cdot$ 1 yr} \\
   & {\color{gray}Paris, France} \\
