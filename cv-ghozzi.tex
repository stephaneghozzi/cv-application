...
\hyphenation{di-sease tra-vel-ling ana-ly-ses rea-lize vi-sua-li-za-tion a-na-ly-zing e-pi-de-mio-lo-gy}
...
\noindent\begin{minipage}{0.7\linewidth}
   ...
   \normalsize
   \vspace{1.5em}
   \noindent I am an independent data scientist crafting bespoke computational tools, applications, analyses, and visualizations. With \textit{honesty} as a core value of my work, I employ machine learning, mathematical and statistical modelling, scientific simulation, and generative and interactive design in projects carefully tailored to address complex and nuanced problems.

   \vspace{1em}

   \textit{To me, honesty in data science is treating insights and uncertainty equally, valuing domain expertise while contributing to its progress, celebrating diversity of viewpoints while striving for clarity. What satisfies us need not only be numbers that match; it can be finding meaning, enabling action, or simply enjoying an elegant perspective.}

   \vspace{1em}
  
   Graduate of the École normale supérieure in Paris; Physics PhD; experience in theoretical physics, experimental biophysics, infectious-disease modelling and surveillance; fluent in English, French, and German; he/him.
   
\end{minipage}
\begin{minipage}{0.3\linewidth}
   \begin{center}
      \includegraphics[width=0.7\textwidth]{portrait-m-r-lr.png}
   \end{center}
\end{minipage} 
...
\href{https://github.com/stephaneghozzi}{github.com/stephaneghozzi} $\cdot$ \href{https://mastodon.social/@stephaneghozzi}{mastodon.social/@stephaneghozzi} $\cdot$ \href{https://linkedin.com/in/stephaneghozzi}{linkedin.com/in/stephaneghozzi} $\cdot$ \href{https://orcid.org/0000-0002-3911-9573}{orcid.org/0000-0002-3911-9573} $\cdot$ \href{https://scholar.google.com/citations?user=uGVLwREAAAAJ}{scholar.google.com/citations?user=uGVLwREAAAAJ}
...
\noindent \begin{Large}Experience\end{Large}
\noindent \begin{longtable}{@{}p{3.1cm}@{}@{}p{13.9cm}@{}}
   & \\
   \textbf{Data scientist} & \textbf{independent} \\
   & {\color{gray}\printdate{2026-2-1} -- present $\cdot$ \difftoday{2026}{2}{1}} \\ 
   & {\color{gray}Lyon, France} \\
   & \href{https://stephaneghozzi.com}{stephaneghozzi.com} \\
   & Data analysis and visualization, digital applications and processes, generative design. \\
   & \\
   & \\   
   \textbf{Data scientist} & \textbf{World Health Organization (WHO)} \\
   & {\color{gray}\printdate{2023-5-25} -- \printdate{2026-1-31} $\cdot$ 2 yrs 8 mos} \\ 
   & {\color{gray}Berlin, Germany} \\
   & WHO Hub for Pandemic and Epidemic Intelligence \\
   & \href{https://pandemichub.who.int}{pandemichub.who.int} \\
   & \\
   & \begin{tabular}[t]{@{}!{\color{gray}\vrule}p{0.2cm}@{}p{13.3cm}@{}}  
      & International Pathogen Surveillance Network (IPSN) \\ 
      & \href{https://www.who.int/initiatives/international-pathogen-surveillance-network}{who.int/initiatives/international-pathogen-surveillance-network} \\
      & $\cdot$ member of the team leading global efforts towards making pathogen genomic surveillance data infrastructure, analysis, and sharing more accessible, equitable, and sustainable \\
      & $\cdot$ stakeholder engagement, meeting preparation, output synthesis, technological advancements and research monitoring, to formulate a work plan for the implementation of WHO's Global Genomic Surveillance Strategy \\
   \end{tabular} \\
\end{longtable}
...
\noindent \begin{longtable}{@{}p{3.1cm}@{}@{}p{13.9cm}@{}} 
   ...
   & \\      
   \textbf{Data scientist} & \textbf{independent} \\
   & {\color{gray}\printdate{2022-11-1} -- \printdate{2023-5-24} $\cdot$ 7 mos} \\ 
   & {\color{gray}Berlin, Germany} \\
   & \href{https://stephaneghozzi.com}{stephaneghozzi.com} \\
   ...
   \textbf{associate} & {\color{gray}\printdate{2020-6-1} -- \printdate{2022-5-31} $\cdot$ 2 yrs} \\ 
...
\noindent \begin{longtable}{@{}p{3.1cm}@{}@{}p{13.9cm}@{}} 
   ...
   \textbf{associate} & {\color{gray}\printdate{2016-4-15} -- \printdate{2020-5-31} $\cdot$ 4 yrs 2 mos}\\ 
   & {\color{gray}Berlin, Germany}\\
   ...
   & {\color{gray}\printdate{2019-5-1} -- \printdate{2019-10-31} $\cdot$ 6 mos} \\ 
   ...
   & \\
   & \\
   \textbf{Visual artist} & \textbf{independent} \\
   & {\color{gray}\printdate{2012-3-1} -- \printdate{2016-4-14} $\cdot$ 4 yrs 1 mo} \\ 
   & {\color{gray}Berlin, Germany} \\
   ...
   \textbf{researcher} & {\color{gray}\printdate{2010-3-1} -- \printdate{2012-2-29} $\cdot$ 2 yrs}\\
   ...
   \textbf{assistant} & {\color{gray}\printdate{2010-9-1} -- \printdate{2012-1-30} $\cdot$ 1 yr 5 mos} \\
   & {\color{gray}Cologne, Germany} \\   
   & Mathematics and statistical physics for Bachelor students.\\
   & \\
   & \textbf{UPMC Sorbonne Universités} \\
   & {\color{gray}\printdate{2005-10-1} -- \printdate{2009-8-31} $\cdot$ 3 yrs 11 mos} \\
   ...
   \textbf{researcher} & {\color{gray}\printdate{2005-9-1} -- \printdate{2009-12-31} $\cdot$ 4 yrs 4 mos} \\
   & {\color{gray}Paris, France} \\
...
\noindent \begin{longtable}{@{}p{3.1cm}@{}@{}p{13.9cm}@{}} 
   ...
   \textbf{Founding} & {\color{gray}\printdate{2007-8-1} -- \printdate{2009-8-31} $\cdot$ 2 yrs 1 mo} \\
   ...
   & {\color{gray}\printdate{2005-2-1} -- \printdate{2005-3-31} $\cdot$ 2 mos} \\
   ...
   & {\color{gray}\printdate{2003-1-17} -- \printdate{2003-8-31} $\cdot$ 7 mos} \\
   ...
   & {\color{gray}\printdate{2002-6-1} -- \printdate{2002-8-31} $\cdot$ 3 mos} \\
   & {\color{gray}Paris, France} \\   
...
\noindent \begin{Large}Education\end{Large}
\noindent \begin{longtable}{@{}p{3.1cm}@{}@{}p{13.9cm}@{}}
   & \\
   \textbf{Certifications} & \textbf{Coursera}\\
   & {\color{gray}\printdate{2016-1-1} -- \printdate{2016-3-31} $\cdot$ 3 mos} \\
...
\noindent \begin{longtable}{@{}p{3.1cm}@{}@{}p{13.9cm}@{}}      
   ...
   & {\color{gray}\printdate{2005-9-1} -- \printdate{2009-12-31} $\cdot$ 4 yrs 4 mos} \\
   & {\color{gray}Paris, France} \\
   ...
   \textbf{M.Sc.} & {\color{gray}\printdate{2001-9-1} -- \printdate{2005-8-31} $\cdot$ 4 yrs} \\
   & {\color{gray}Paris, France} \\
   ...
   & \\
   & \\   
   \textbf{Postgraduate} & \textbf{École nationale supérieure des arts décoratifs} \\
   \textbf{certificate}& {\color{gray}\printdate{2003-9-1} -- \printdate{2004-8-31} $\cdot$ 1 yr} \\
   & {\color{gray}Paris, France} \\
...
\noindent \begin{Large}Skills\end{Large}
\noindent \begin{longtable}{@{}p{3.1cm}@{}@{}p{13.9cm}@{}}
   & \\
...
\noindent \begin{Large}Selected projects\end{Large}
\noindent \begin{longtable}{@{}p{3.1cm}@{}@{}p{13.9cm}@{}}
   & \\
