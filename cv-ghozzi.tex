...
\noindent \begin{longtable}{@{}p{3.1cm}@{}@{}p{13.9cm}@{}}
   ...
   & \begin{tabular}[t]{@{}!{\color{gray}\vrule}p{0.2cm}@{}p{13.3cm}@{}}  
      ...
      & $\cdot$ part the team leading global efforts towards making pathogen genomic surveillance data infrastructure, analysis, and sharing more accessible, equitable, and sustainable \\
