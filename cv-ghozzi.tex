...
\href{https://www.stephaneghozzi.com}{stephaneghozzi.com} $\cdot$ \href{https://orcid.org/0000-0002-3911-9573}{orcid.org/0000-0002-3911-9573} \\ \href{https://gitlab.com/stephaneghozzi}{gitlab.com/stephaneghozzi} $\cdot$
\href{https://twitter.com/stephaneghozzi}{twitter.com/stephaneghozzi} \\ \href{https://www.linkedin.com/in/stephaneghozzi}{linkedin.com/in/stephaneghozzi} $\cdot$ \href{https://scholar.google.com/citations?user=uGVLwREAAAAJ}{scholar.google.com/citations?user=uGVLwREAAAAJ}
...
\noindent \begin{longtable}{@{}p{3.1cm}@{}@{}p{13.9cm}@{}}
   ...
   & \\
   \textbf{contrastR} & R package for simulating epidemics on contact network under resource-constrained contact-tracing prioritization strategies: \\
   & \href{https://gitlab.com/stephaneghozzi/contrastR}{gitlab.com/stephaneghozzi/contrastR} \\   
   & \\   
   \textbf{sormasdatagen} & R package for generating synthetic data for the outbreak management software SORMAS: \href{https://gitlab.com/stephaneghozzi/sormasdatagen}{gitlab.com/stephaneghozzi/sormasdatagen} \\
   & \\   
   \textbf{asmodee-trendbreaker-evaluation} & R scripts for evaluating the ASMODEE algorithm on time series and NHS pathways:
   \href{https://gitlab.com/stephaneghozzi/asmodee-trendbreaker-evaluation}{gitlab.com/stephaneghozzi/asmodee-trendbreaker-evaluation} \\
   & \\
   \textbf{wotva} & Prototypical R Shiny dashboard and analyses for the investigation of outbreaks of unknown origins: \href{https://gitlab.com/stephaneghozzi/wotva}{gitlab.com/stephaneghozzi/wotva} \\
   & \\
   \textbf{eios-anomaly} & Python notebooks for simple NLP and machine learning to identify epidemiologically relevant texts: \href{https://gitlab.com/stephaneghozzi/eios-anomaly}{gitlab.com/stephaneghozzi/eios-anomaly}  \\
   & \\
   \textbf{infectious-disease-severity-dashboard} & R Shiny dashboard to compute and visualize the severity of infectious diseases following the PISA recommendations of WHO: \href{https://gitlab.com/stephaneghozzi/infectious-disease-severity-dashboard}{gitlab.com/stephaneghozzi/infectious-disease-severity-dashboard}  \\
   & \\
   \textbf{signale-logo} & Processing scripts to generate patterns used for the graphic identity of the Signale team of the Robert Koch Institute: \href{https://gitlab.com/stephaneghozzi/signale-logo}{gitlab.com/stephaneghozzi/signale-logo} \\
   & \\
   \textbf{correlation-dance} & Processing scripts to visualize the movement correlations between dancers from motion capture data: \href{https://gitlab.com/stephaneghozzi/correlation-dance}{gitlab.com/stephaneghozzi/correlation-dance}   
\end{longtable}
